            ...
            if (result.success === false && !result.searchedProduct) {
                ...
                try {
                    ...
                    if(error instanceof TypeError){
                        setError("provavelmente este produto tem campos faltantes na busca online! preencha-o com mais carinho!")
                    }
                    else{
                        setError("Erro ao buscar produto! \n" + (error.error ? error.error : error.message).toString());
                    }
                }
            }
        }
    ...
    return (
        <div className='flex flex-col items-center p-3 w-full'>
            <div className='w-full flex flex-col'>
                <h1 className='text-2xl font-bold text-center'>Cadastro de Produtos</h1>
            </div>
            ...
            {trocarFormulario ?
                (<div className='w-full flex flex-col'>
                    ...
                    {newProduct ? (
                        ...
                        /* este é o formulário inicial que pergunta o códigom de barras */
                    ...
                    <form onSubmit={handleFormSubmit} className='w-full flex grid flex-col'>
                        <div className='flex flex-col space-y-1.5 mt-2 '>
                            <Label htmlFor="codigo">Código de barras</Label>
                            <Input name='codigo' type='text' value={produto ? (produto.codigo) : ('')} disabled />
                        </div>
                        <div className='flex flex-col space-y-1.5 mt-2 '>
                        ...
                        <div className='flex flex-row w-full space-x-48 mt-2'>
                            ...
                            <div className="flex flex-col space-y-1.5 mt-2 w-full pb-5">
